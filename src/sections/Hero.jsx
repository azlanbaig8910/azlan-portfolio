          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight animate-fade-in animation-delay-100">
                Frontend <span className="text-primary glow-text">Developer</span>
                <br />
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <AnimatedBorderButton
                href="/Azlans_Resume.pdf"
                download="Azlans_Resume.pdf"
              >
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/azlanbaig8910" },
                // { icon: Linkedin, href: "#" },
                // { icon: Twitter, href: "#" },
              ].map((social, idx) => (
                <a
